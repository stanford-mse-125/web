...
- `ai-tools.md` — Using AI in MSE 125: HW purpose + responsibility rule ("you take responsibility for the work you submit, even if AI typed it"), recommended tools, prompt templates, academic integrity. Consolidated 2026-05-04 from former `course-ai-prompts.md`.
