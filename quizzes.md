...
Use these practice quizzes to prepare for the weekly in-class quizzes. Each practice set has 10 questions with collapsible solutions — try the questions first, then check your answers.

| Quiz | Covers | Practice quiz |
|------|--------|--------------|
